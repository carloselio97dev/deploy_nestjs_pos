...
import { formatCurrency, getImagePath, isAvaible } from "@/src/utils";
...
export default function ProductCard({ product }: { product: Product }) {
    return (
        ...
        >
            <div className={`${!isAvaible(product.inventory) && 'opacity-40'}`}>
                <Image
            ...
            </div>
            {
                ...
                (
                    ...
                    opacity-60 
                    w-full text-center py-5 text-2xl uppercase font-black">Agotado</p>
                )
            }
